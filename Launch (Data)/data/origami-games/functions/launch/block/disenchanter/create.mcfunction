...
summon armor_stand ~ ~ ~ {Tags:["lch_entity","lch_fire","lch_crafter","lch_disenchanter"],NoGravity:1,Small:1,Marker:1,Invisible:1,CustomNameVisible:0,CustomName:'{"translate":"block.launch.disenchanter"}',Fire:17}
