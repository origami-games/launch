...
execute if entity @s[nbt={Item:{tag:{origami-games:{launch:{spirit_type:"coal"}}}}}] run replaceitem entity @e[type=vex,tag=lch_ore_spirit,sort=nearest,limit=1] armor.head coal_ore
...
execute if entity @s[nbt={Item:{tag:{origami-games:{launch:{spirit_type:"diamond"}}}}}] run replaceitem entity @e[type=vex,tag=lch_ore_spirit,sort=nearest,limit=1] armor.head diamond_ore
...
execute if entity @s[nbt={Item:{tag:{origami-games:{launch:{spirit_type:"emerald"}}}}}] run replaceitem entity @e[type=vex,tag=lch_ore_spirit,sort=nearest,limit=1] armor.head emerald_ore
