...
scoreboard players operation @s lch_mo_sp_random /= #3 lch_mo_sp_random

execute if score @s lch_mo_sp_random matches 3 run function origami-games:launch/entity/spawning/check_conditions
