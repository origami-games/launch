...
#magnetite ore
execute store result score $meteor_ore lch_world_gen run fill ~-4 ~-4 ~-4 ~4 ~4 ~4 spawner{SpawnData:{id:armor_stand,Tags:["lch_entity","lch_mistake_spawn"],ArmorItems:[{},{},{},{id:spawner,Count:1,tag:{origami-games:{launch:{block:"magnetite_ore"}},CustomModelData:7510004}}]},RequiredPlayerRange:0} replace #origami-games:launch/world/structure/meteor/can_replace_ore
