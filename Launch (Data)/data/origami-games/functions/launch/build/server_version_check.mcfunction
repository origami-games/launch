...
#summon test entity
summon minecraft:armor_stand ~ 0 ~ {HandItems:[{id:"minecraft:trident",Count:1b,tag:{update:13}},{id:"minecraft:lectern",Count:1b,tag:{update:14}}],ArmorItems:[{id:"minecraft:stick",Count:1b,tag:{update:15}},{id:"minecraft:stick",Count:1b,tag:{update:16}},{id:"minecraft:stick",Count:1b,tag:{update:17}},{id:"minecraft:stick",Count:1b,tag:{update:18}}],Tags:["lch_ver_check"],Invisible:1b,Marker:1b,Small:1b,NoBasePlate:1b,Invulnerable:1b}
#test hand items
