...
data modify storage launch:module dependency_issues set value []
...
execute if data storage launch:module dependency_issues[] run function launch:dependency_issues
